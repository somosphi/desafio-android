...
class StatementsPageAdapter(diffCallback: DiffUtil.ItemCallback<StatementMessage>) :
    ...
    class StatementViewHolder(private val binding: StatementItemBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    object StatementComparator : DiffUtil.ItemCallback<StatementMessage>() {
        override fun areItemsTheSame(oldItem: StatementMessage, newItem: StatementMessage): Boolean {
            return oldItem.id == newItem.id
        }

        override fun areContentsTheSame(oldItem: StatementMessage, newItem: StatementMessage): Boolean {
